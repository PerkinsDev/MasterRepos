...
namespace AP_Csharp_Exercises
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            float gradeOne = 0.0f;
            float gradeTwo = 0.0f;
            float gradeThree = 0.0f;
            float finalGrade = 0.0f;

            Console.WriteLine("We are going to calculate your grade point average based on 3 test scores.");
            Console.WriteLine("Enter grade 1: ");
            gradeOne =  float.Parse(Console.ReadLine());
            Console.WriteLine("Enter grade 2: ");
            gradeTwo = float.Parse(Console.ReadLine());
            Console.WriteLine("Enter grade 3: ");
            gradeThree = float.Parse(Console.ReadLine());
